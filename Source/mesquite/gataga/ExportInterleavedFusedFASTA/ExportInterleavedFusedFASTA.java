package mesquite.gataga.ExportInterleavedFusedFASTA;
...
public class ExportInterleavedFusedFASTA extends FileInterpreterI {
	/*.................................................................................................................*/
	...
	protected String getTaxonName(Taxa taxa, int it, CharacterData data){
			return taxa.getTaxonName(it) + " " + data.getName();
		...
		for (int it = 0; it<numTaxa; it++){  //go through the taxa
			if (!writeOnlySelectedTaxa || (taxa.getSelected(it))) {   // find the taxa to write
				for (int im=0; im<numMatrices; im++) {
					...
					boolean sameClass = data.getClass().isAssignableFrom(firstData.getClass());
					if ((data instanceof CategoricalData) && sameClass) {  // write data for this matrix
	...
	public String getName() {
		return "Fused Interleaved FASTA Export";
	}
	/*.................................................................................................................*/

	/** returns an explanation of what the module does.*/
	public String getExplanation() {
		return "Exports FASTA files with sequences of all matrices interleaved taxon by taxon." ;
	}
	/*.................................................................................................................*/
