...
/* ======================================================================== */
public class OLDProcessFastaFiles extends GeneralFileMaker { 
	...
	/*.................................................................................................................*/
	void processFile(MesquiteFile fileToRead, StringBuffer results) {
		...
		if (fileToRead.openReading()) {
			...
			if (manager!=null)
				manager.fileReadIn(fileToWrite);

			fileToWrite.setFileName(fileToRead.getFileName()+".nex");

		//	importer.readFile(getProject(), fileToRead, null);	
			
			importer.readFileCore(parser, fileToRead, data,  taxa, progIndicator, null);	
