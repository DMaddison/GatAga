...
package mesquite.gataga.TaxonListEValue;
/*~~  */
...
/* ======================================================================== */
public class TaxonListEValue extends TaxonListAssistant {
	...
	public String getStringForTaxon(int ic){
		...
		if (currentTaxa!=null) {
			...
			double eValue = associable.getAssociatedDouble(NCBIUtil.EVALUE, ic);
			if (MesquiteDouble.isCombinable(eValue))
				return "" + associable.getAssociatedDouble(NCBIUtil.EVALUE, ic);
	...
	public String getExplanation() {
		return "Lists eValue for top BLAST match." ;
	}
}
