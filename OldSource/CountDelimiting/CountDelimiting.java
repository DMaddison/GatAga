package mesquite.gataga.CountDelimiting;
...
public class CountDelimiting extends NumberForMatrix {
	...
	public String getName() {
		return "Number of Sites Delimiting Selected Taxa-";
	} 

	public String getExplanation(){
		return "Counts the number of sites with two states whose distribution matches m.";
	} 
